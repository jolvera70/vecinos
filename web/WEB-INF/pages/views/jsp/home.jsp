            ...
            <div class=" col-md-8 col-sm-8">
                ...
                <div class="media">
                    <a class="media-left" href="#">
                        <img src="/vecinos/resources/assets/img/1.jpg" alt="" class="img-rounded" />
                    </a>
                ...
                <div class="media">
                    <a class="media-left" href="#">
                        <img src="/vecinos/resources/assets/img/2.jpg" alt="" class="img-rounded" />
                    </a>
                    <div class="media-body">
                        <h4 class="media-heading">Media heading</h4>
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
...
<!-- JQUERY SCRIPTS -->
<script src="/vecinos/resources/assets/js/jquery-1.11.1.js"></script>
<!-- BOOTSTRAP SCRIPTS -->
<script src="/vecinos/resources/assets/js/bootstrap.js"></script>
<!-- METISMENU SCRIPTS -->
<script src="/vecinos/resources/assets/js/jquery.metisMenu.js"></script>
<!-- CUSTOM SCRIPTS -->
<script src="/vecinos/resources/assets/js/custom.js"></script>
